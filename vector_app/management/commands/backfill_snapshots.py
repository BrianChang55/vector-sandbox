...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        existing_snapshot_ids = VersionStateSnapshot.objects.values_list("app_version_id", flat=True)
        versions_without_snapshots = versions_qs.exclude(id__in=existing_snapshot_ids).order_by("created_at")
        ...
        total_versions = AppVersion.objects.filter(generation_status=AppVersion.GEN_STATUS_COMPLETE).count()
