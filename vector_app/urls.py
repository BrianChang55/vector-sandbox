"""
URL configuration for vector_app.
"""
...
router.register(
    r"orgs/(?P<organization_pk>[^/.]+)/apps", internal_app_views.InternalAppViewSet, basename="internal-app"
)
router.register(
    r"apps/(?P<internal_app_pk>[^/.]+)/versions", version_views.AppVersionViewSet, basename="app-version"
)
...
urlpatterns = [
    ...
    path("orgs/<uuid:org_id>/members/", member_views.OrgMembersListView.as_view(), name="org-members-list"),
    ...
    path("orgs/<uuid:org_id>/invites/", member_views.OrgInviteListView.as_view(), name="org-invites"),
    ...
    # =========================================================================
    path(
        "orgs/<uuid:org_id>/favorites/", internal_app_views.AppFavoritesView.as_view(), name="app-favorites"
    ),
    path(
    ...
    path(
        "backends/<uuid:pk>/test/",
        backend_connection_views.BackendConnectionViewSet.as_view({"post": "test"}),
        name="backend-test",
    ),
    path(
        "backends/<uuid:pk>/user-auth/",
        backend_connection_views.BackendConnectionViewSet.as_view({"post": "user_auth"}),
        name="backend-user-auth",
    ),
    path(
        "orgs/<uuid:pk>/switch/",
        organization_views.OrganizationViewSet.as_view({"post": "switch"}),
        name="org-switch",
    ),
    ...
    path(
        "versions/<uuid:pk>/",
        version_views.AppVersionViewSet.as_view({"get": "retrieve"}),
        name="version-detail",
    ),
    path(
        "versions/<uuid:pk>/rollback/",
        version_views.AppVersionViewSet.as_view({"post": "rollback"}),
        name="version-rollback",
    ),
    path(
        "versions/<uuid:pk>/save-files/",
        version_views.AppVersionViewSet.as_view({"post": "save_files"}),
        name="version-save-files",
    ),
    path(
        "versions/<uuid:version_id>/cancel/",
        streaming_views.CancelGenerationView.as_view(),
        name="version-cancel",
    ),
    path(
        "versions/<uuid:version_id>/fix-errors/",
        streaming_views.FixErrorsView.as_view(),
        name="version-fix-errors",
    ),
    path(
        "resources/<uuid:pk>/",
        resource_registry_views.ResourceRegistryEntryViewSet.as_view(
    ...
    path(
        "apps/<uuid:app_id>/chat-sessions/",
        streaming_views.ChatSessionViewSet.as_view(),
        name="chat-sessions",
    ),
    path(
        "chat-sessions/<uuid:session_id>/messages/",
        streaming_views.ChatMessagesView.as_view(),
        name="chat-messages",
    ),
    path("apps/<uuid:app_id>/generate/", streaming_views.NonStreamingGenerateView.as_view(), name="generate"),
    path(
        "apps/<uuid:app_id>/generate/stream/",
        streaming_views.StreamingGenerateView.as_view(),
        name="generate-stream",
    ),
    path(
        "apps/<uuid:app_id>/generate/agentic/",
        streaming_views.AgenticGenerateView.as_view(),
        name="generate-agentic",
    ),
    path(
        "apps/<uuid:app_id>/latest-generation/",
        streaming_views.LatestGenerationView.as_view(),
        name="latest-generation",
    ),
    path(
        "versions/<uuid:version_id>/generation-state/",
        streaming_views.GenerationStateView.as_view(),
        name="generation-state",
    ),
    path(
        "messages/<uuid:message_id>/apply/",
        streaming_views.ApplyGeneratedCodeView.as_view(),
        name="apply-generated",
    ),
    ...
    path("public/integrations/", connector_views.public_integrations_list, name="public-integrations"),
    ...
    path("integrations/<uuid:pk>/sync/", connector_views.sync_connectors, name="integration-sync"),
    path(
        "integrations/<uuid:pk>/connectors/", connector_views.list_connectors, name="integration-connectors"
    ),
    path(
    ...
    path(
        "integrations/<uuid:pk>/tool-pack/", connector_views.get_tool_pack_info, name="integration-tool-pack"
    ),
    path("integrations/<uuid:pk>/mcp/", connector_views.get_mcp_config, name="integration-mcp"),
    path("integrations/<uuid:pk>/mcp/tools/", connector_views.list_mcp_tools, name="integration-mcp-tools"),
    path("integrations/<uuid:pk>/mcp/call/", connector_views.call_mcp_tool, name="integration-mcp-call"),
