...
class AppFavoritesView(APIView):
    ...
    def get(self, request, org_id):
        ...
        favorites = AppFavorite.objects.filter(user=request.user, organization=organization).select_related(
            "app"
        )
    ...
    def post(self, request, org_id):
        ...
        favorite, created = AppFavorite.objects.get_or_create(
            user=request.user, organization=organization, app=app
        )
...
class AppFavoriteDetailView(APIView):
    ...
    def delete(self, request, org_id, app_id):
        ...
        deleted_count, _ = AppFavorite.objects.filter(
            user=request.user, organization=organization, app_id=app_id
        ).delete()
