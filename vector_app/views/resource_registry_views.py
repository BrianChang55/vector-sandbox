    ...
    def get_queryset(self):
        ...
        if backend_id:
            ...
            try:
                ...
                if not self.request.user.user_organizations.filter(organization=backend.organization).exists():
        ...
        return ResourceRegistryEntry.objects.filter(
            backend_connection__organization_id__in=user_org_ids
        )
