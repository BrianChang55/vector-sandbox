...
class AppDataTableViewSet(viewsets.ViewSet):
    ...
    def list(self, request, internal_app_pk=None):
        ...
        if not app:
            return Response({"error": "App not found or access denied"}, status=status.HTTP_404_NOT_FOUND)
    ...
    def create(self, request, internal_app_pk=None):
        ...
        return Response(AppDataTableSerializer(table).data, status=status.HTTP_201_CREATED)
...
class AppDataRowViewSet(viewsets.ViewSet):
    ...
    def create(self, request, internal_app_pk=None, table_slug=None):
        ...
        return Response(AppDataRowSerializer(row).data, status=status.HTTP_201_CREATED)
...
class AppDataRowBulkView(APIView):
    ...
    def post(self, request, internal_app_pk=None, table_slug=None):
        ...
        created_rows, errors = AppDataService.insert_rows_bulk(table, serializer.validated_data["rows"])
    ...
    def delete(self, request, internal_app_pk=None, table_slug=None):
        ...
        deleted_count = AppDataService.delete_rows_bulk(table, serializer.validated_data["row_ids"])
