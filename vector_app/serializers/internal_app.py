...
class InternalAppSerializer(serializers.ModelSerializer):
    ...
    published_at = serializers.DateTimeField(source='published_version.created_at', read_only=True, allow_null=True)
    ...
    class Meta:
        ...
        read_only_fields = ['id', 'slug', 'created_by', 'created_at', 'updated_at', 'published_version_id', 'published_version_number', 'published_at']
