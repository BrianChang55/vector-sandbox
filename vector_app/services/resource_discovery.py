...
class ResourceDiscoveryService:
    ...
    def _get_adapter_context(self, backend_connection: BackendConnection) -> AdapterContext:
        ...
        elif backend_connection.adapter_type in [BackendConnection.ADAPTER_POSTGRESQL, BackendConnection.ADAPTER_MYSQL]:
            return AdapterContext(
    ...
    def discover_resources(self, backend_connection: BackendConnection) -> List[ResourceRegistryEntry]:
        ...
        logger.info(f"Discovering resources for {backend_connection.display_name} ({backend_connection.adapter_type})")
