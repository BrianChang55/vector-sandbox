...
Loads and formats the vector-manifest.json for injection into AI prompts.
...
def get_manifest_path() -> Path:
    """Get the path to the vector-manifest.json file."""
    # The manifest is located in the vector-template directory
    # Path: services/ -> vector_app/ -> internal-apps-backend/ -> internal-apps/
    base_path = Path(__file__).parent.parent.parent.parent
    manifest_path = base_path / "vector-template" / "vector-manifest.json"
