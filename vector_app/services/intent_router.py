...
class IntentRouter:
    ...
    def _build_confirmation_details(
        ...
        if intent.is_compound:
            ...
            details["operations"] = [intent.intent.value] + [s.intent.value for s in intent.secondary_intents]
    ...
    def _build_confirmation_message(
        ...
        if intent.confidence < self.CONFIDENCE_THRESHOLD_FOR_CONFIRMATION:
            return (
                ...
                "Proceeding with: " + self._describe_compound_intent(intent)
                if intent.is_compound
