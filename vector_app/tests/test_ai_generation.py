...
from ..models import User, Organization, UserOrganization, InternalApp, ChatSession, ChatMessage, AppVersion
...
class ChatSessionModelTests(TestCase):
    ...
    def test_chat_message_creation(self):
        ...
        session = ChatSession.objects.create(internal_app=self.app, created_by=self.user)
...
class StreamingViewsTests(TestCase):
    ...
    def test_chat_sessions_list(self):
        ...
        ChatSession.objects.create(internal_app=self.app, title="Test Session", created_by=self.user)
    ...
    def test_create_chat_session(self):
        ...
        response = self.client.post(
            f"/api/v1/apps/{self.app.id}/chat-sessions/", {"title": "New Chat", "model_id": "openai/gpt-4o"}
        )
