...
class SchemaMigrationService:
    ...
    def check_compatibility(
        ...
        for col_name in added_columns:
            ...
            if is_required:
                ...
                warnings.append(
                    f"Column '{col_name}' will be added to schema with default/nullable values."
                )
            ...
            if change['change'] == 'removed':
                ...
                if change['risk'] == 'danger':
                    ...
                    hints.append({
                        ...
                        'severity': 'info',
                        'suggestion': (
                            f"Column '{col_name}' will be added with default/null values."
                        ),
                        'action': 'none_required',
                    })
    ...
    def _get_type_conversion_hint(cls, from_type: str, to_type: str, col_name: str) -> str:
        ...
        hints = {
            ...
            ('datetime', 'date'): (
                f"Column '{col_name}' is changing from datetime to date. "
                f"Time information will be lost."
            ),
            ('text', 'string'): (
                f"Column '{col_name}' is changing from text to string. "
                f"Long text values may be truncated."
            ),
        }
