"""
Celery Tasks for Relay Internal Apps
...
def run_agentic_generation(self, job_id: str):
    ...
    from relay_app.services.agentic_service import get_agentic_service
    from relay_app.services.version_service import VersionService
    from relay_app.services.snapshot_service import SnapshotService
...
def _append_event(job, event_type: str, data: dict):
    ...
    """
    from relay_app.models import CodeGenerationJob
