...
from relay_app.adapters.base import AdapterContext, UserContext, Resource, ResourceField, Relationship, ResourceSchema
from relay_app.adapters.supabase import SupabaseAdapter
from relay_app.adapters.postgresql import PostgreSQLAdapter
from relay_app.adapters.mysql import MySQLAdapter
...
class TestPostgreSQLAdapter(TestCase):
    ...
    @patch('relay_app.adapters.postgresql.psycopg2.connect')
...
class TestMySQLAdapter(TestCase):
    ...
    @patch('relay_app.adapters.mysql.pymysql.connect')
    def test_test_connection_success(self, mock_connect):
        """Test successful connection test."""
        mock_conn = MagicMock()
        mock_cursor = MagicMock()
...
class TestAdapterFactoryPattern(TestCase):
    ...
    def test_get_postgresql_adapter(self):
        ...
        from relay_app.views.backend_connection_views import get_adapter
        from relay_app.models import BackendConnection
