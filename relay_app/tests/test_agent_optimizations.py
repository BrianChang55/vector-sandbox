...
from relay_app.services.context_analyzer import (
    ContextAnalyzer,
    AppContext,
    FileInfo,
    TableInfo,
...
from relay_app.services.intent_router import (
    IntentRouter,
    get_intent_router,
)
from relay_app.services.handlers.base_handler import (
    StreamingValidator,
    AgentEvent,
    FileChange,
    PlanStep,
...
class TestParallelContextGathering(TestCase):
    ...
    def test_gather_context_parallel_with_none_app(self):
        ...
        from relay_app.services.agentic_service import AgenticService
    ...
    @patch('relay_app.services.agentic_service.build_data_store_context')
    @patch('relay_app.services.agentic_service.build_mcp_tools_context')
...
class TestHandlerIntegration(TestCase):
    ...
    def test_edit_handler_imports_over_eagerness_guard(self):
        ...
        from relay_app.services.handlers.edit_handler import EDIT_SYSTEM_PROMPT
    ...
    def test_feature_handler_imports_over_eagerness_guard(self):
        ...
        from relay_app.services.handlers.feature_handler import FEATURE_SYSTEM_PROMPT
