 ...
 * 
 * All data operations go through this client, which proxies to the Relay backend.
...
function getConfig(): RuntimeConfig {
  if (typeof window !== 'undefined' && (window as any).__RELAY_CONFIG__) {
    return (window as any).__RELAY_CONFIG__;
  }
...
export const metadata = {{
  title: '{app_name}',
  description: 'Internal application built with Relay',
}};
